...
describe('ColorPicker', () => {
  ...
  describe('Components Visibility', () => {
    ...
    it('should hide alpha slider when showAlpha is false', () => {
      ...
      expect(screen.queryByRole('slider', { name: /alpha/i })).not.toBeInTheDocument();
    });
    ...
    it('should hide eyedropper when showEyeDropper is false', () => {
  ...
  describe('User Interactions', () => {
    ...
    it('should have onChangeComplete prop', () => {
      ...
      render(<ColorPicker defaultValue="#FF0000" onChangeComplete={onChangeComplete} />);
  ...
  describe('Color History', () => {
    ...
    it('should respect historySize prop', () => {
      render(<ColorPicker enableHistory={true} historySize={5} />);
  ...
  describe('Accessibility', () => {
    it('should have proper ARIA labels', () => {
      ...
      expect(screen.getByRole('slider', { name: /hue/i })).toHaveAttribute('aria-label');
      expect(screen.getByRole('slider', { name: /alpha/i })).toHaveAttribute('aria-label');
    });
