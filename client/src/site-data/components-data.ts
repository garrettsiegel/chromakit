...
import { displayGroup } from './components-data-display';
...
export const componentGroups: ComponentGroup[] = [
  ...
  displayGroup,
  {
    ...
    components: [
      ...
      {
        name: 'RGBInputs · HSLInputs · HSVInputs · OKLCHInputs · OKLABInputs',
        description:
          'Fixed per-space channel fields. Identical prop shape across all five.',
